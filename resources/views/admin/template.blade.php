  ...
  @include('sweetalert::alert', ['cdn' => "https://cdn.jsdelivr.net/npm/sweetalert2@9"])
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('admin.product.create.index') }}">
            <svg class="nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-library-add"></use>
            </svg> Tambah<span class="badge badge-sm bg-info ms-auto">NEW</span></a></li>
        <li class="nav-item"><a class="nav-link" href="{{ route('admin.profile.index') }}">
            <svg class="nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-user"></use>
            </svg> Profile<span class="badge badge-sm bg-info ms-auto">NEW</span></a></li>
        <li class="nav-item">
          <form action="{{ route('auth.logout') }}" method="post">
            @csrf
            <button class="nav-link" type="submit" onclick="return confirm('yakin logout?')">
              <svg class="nav-icon">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-door"></use>
              </svg> Logout<span class="badge badge-sm bg-info ms-auto">NEW</span>
            </button>
          </form>
        </li>
      </ul>
